"""
Utility functions to be used in main scraping script
"""
import requests
...
class ScrapUtils:
    ...
    def get_category_list():
        ...
        :return: list
        """
        soup = ScrapUtils.make_soup('http://books.toscrape.com/index.html')
        cat_list = []
    ...
    def data_summary():
        ...
        :return: None - prints text summary to console
        """
        df_list = []
        for cat in ScrapUtils.get_category_list():
            try:
                df_list.append(pd.read_csv('data/csv/' + cat + '.csv', sep=';', header=0))
